...
"use strict";function searchTag(e,r){for(var t=0,a=e.length-1;t<=a;){var s=t+a>>>1,n=e[s].tag;if(n===r)return s;n<r?t=s+1:a=s-1}return-t-1}function binSearch(e,r){for(var t=0,a=e.length-1;t<=a;){var s=t+a>>>1,n=e[s];if(n===r)return s;n<r?t=s+1:a=s-1}return-t-1}var Layout={searchTag:searchTag,binSearch:binSearch,getScriptNames:function(){var e=this.getGsubTable();return e?e.scripts.map(function(e){return e.tag}):[]},getScriptTable:function(e,r){var t=this.getGsubTable(r);if(t){var a=t.scripts,s=searchTag(t.scripts,e);if(s>=0)return a[s].script;var n={tag:e,script:{defaultLangSys:{reserved:0,reqFeatureIndex:65535,featureIndexes:[]},langSysRecords:[]}};return a.splice(-1-s,0,n.script),n}},getLangSysTable:function(e,r,t){var a=this.getScriptTable(e,t);if(a){if("DFLT"===r)return a.defaultLangSys;var s=searchTag(a.langSysRecords,r);if(s>=0)return a.langSysRecords[s].langSys;if(t){var n={tag:r,langSys:{reserved:0,reqFeatureIndex:65535,featureIndexes:[]}};return a.langSysRecords.splice(-1-s,0,n),n.langSys}}},getFeatureTable:function(e,r,t,a){var s=this.getLangSysTable(e,r,a);if(s){for(var n,u=s.featureIndexes,i=this.font.tables.gsub.features,g=0;g<u.length;g++)if(n=i[u[g]],n.tag===t)return n.feature;if(a){n={tag:t,feature:{params:0,lookupListIndexes:[]}};var f=i.length;return i.push(n),u.push(f),n.feature}}},getLookupTable:function(e,r,t,a,s){var n=this.getFeatureTable(e,r,t,s);if(n){for(var u,i=n.lookupListIndexes,g=this.font.tables.gsub.lookups,f=0;f<i.length;f++)if(u=g[i[f]],u.lookupType===a)return u;if(s){u={lookupType:a,lookupFlag:0,subtables:[],markFilteringSet:void 0};var o=g.length;return g.push(u),i.push(o),u}}},expandCoverage:function(e){if(1===e.format)return e.glyphs;for(var r=[],t=e.ranges,a=0;a<t;a++)for(var s=t[a],n=s.start,u=s.end,i=n;i<=u;i++)r.push(i);return r}};module.exports=Layout;
...
"use strict";function Path(){this.commands=[],this.pathData,this.fill="black",this.stroke=null,this.strokeWidth=1}Path.prototype.moveTo=function(t,o){this.commands.push({type:"M",x:t,y:o})},Path.prototype.lineTo=function(t,o){this.commands.push({type:"L",x:t,y:o})},Path.prototype.curveTo=Path.prototype.bezierCurveTo=function(t,o,e,h,s,i){this.commands.push({type:"C",x1:t,y1:o,x2:e,y2:h,x:s,y:i})},Path.prototype.quadTo=Path.prototype.quadraticCurveTo=function(t,o,e,h){this.commands.push({type:"Q",x1:t,y1:o,x:e,y:h})},Path.prototype.close=Path.prototype.closePath=function(){this.commands.push({type:"Z"})},Path.prototype.extend=function(t){t.commands&&(t=t.commands),Array.prototype.push.apply(this.commands,t)},Path.prototype.draw=function(t){t.beginPath();for(var o=0;o<this.commands.length;o+=1){var e=this.commands[o];"M"===e.type?t.moveTo(e.x,e.y):"L"===e.type?t.lineTo(e.x,e.y):"C"===e.type?t.bezierCurveTo(e.x1,e.y1,e.x2,e.y2,e.x,e.y):"Q"===e.type?t.quadraticCurveTo(e.x1,e.y1,e.x,e.y):"Z"===e.type&&t.closePath()}this.fill&&(t.fillStyle=this.fill,t.fill()),this.stroke&&(t.strokeStyle=this.stroke,t.lineWidth=this.strokeWidth,t.stroke())},Path.prototype.toPathData=function(){if(this.pathData)return this.pathData;for(var t="",o=0;o<this.commands.length;o+=1){var e=this.commands[o];"M"===e.type?t+="M"+e.x+" "+e.y:"L"===e.type?t+="L"+e.x+" "+e.y:"C"===e.type?t+="C"+e.x1+" "+e.y1+" "+e.x2+" "+e.y2+" "+e.x+" "+e.y:"Q"===e.type?t+="Q"+e.x1+" "+e.y1+" "+e.x+" "+e.y:"Z"===e.type&&(t+="Z")}return this.pathData=t,t},Path.prototype.toSVG=function(t){var o='<path d="';return o+=this.toPathData(t),o+='"',this.fill&"black"!==this.fill&&(o+=null===this.fill?' fill="none"':' fill="'+this.fill+'"'),this.stroke&&(o+=' stroke="'+this.stroke+'" stroke-width="'+this.strokeWidth+'"'),o+="/>"},exports.Path=Path;

},{}],12:[function(require,module,exports){
"use strict";function arraysEqual(t,e){var r=t.length;if(r!==e.length)return!1;for(var s=0;s<r;s++)if(t[s]!==e[s])return!1;return!0}var check=require("./check"),Layout=require("./layout"),Substitution=function(t){this.font=t};Substitution.prototype=Layout,Substitution.prototype.getGsubTable=function(t){var e=this.font.tables.gsub;return!e&&t&&(this.font.tables.gsub=e={version:1,scripts:[{tag:"DFLT",script:{defaultLangSys:{reserved:0,reqFeatureIndex:65535,featureIndexes:[]},langSysRecords:[]}}],features:[],lookups:[]}),e},Substitution.prototype.getLigatures=function(t,e,r){var s=this.getLookupTable(t,e,r,4);if(!s)return[];var a=s.subtables[0];if(!a)return[];for(var u=this.expandCoverage(a.coverage),o=a.ligatureSets,i=[],n=0;n<u.length;n++)for(var g=u[n],l=o[n],c=0;c<l.length;c++){var b=l[c];i.push({sub:[g].concat(b.components),by:b.ligGlyph})}return i},Substitution.prototype.addLigature=function(t,e,r,s){var a=this.getLookupTable(t,e,r,4,!0),u=a.subtables[0];u||(u={substFormat:1,coverage:{format:1,glyphs:[]},ligatureSets:[]},a.subtables[0]=u),check.assert(1===u.coverage.format,"Ligature: unable to modify coverage table format "+u.coverage.format);var o=s.sub[0],i=s.sub.slice(1),n={ligGlyph:s.by,components:i},g=this.binSearch(u.coverage.glyphs,o);if(g>=0){for(var l=u.ligatureSets[g],c=0;c<l.length;c++)if(arraysEqual(l[c].components,i))return;l.push(n)}else g=-1-g,u.coverage.glyphs.splice(g,0,o),u.ligatureSets.splice(g,0,[n])},Substitution.prototype.getFeature=function(t,e,r){switch(1===arguments.length&&(r=arguments[0],t=e="DFLT"),r){case"dlig":case"liga":case"rlig":return this.getLigatures(t,e,r)}},Substitution.prototype.add=function(t,e,r,s){switch(2===arguments.length&&(r=arguments[0],s=arguments[1],t=e="DFLT"),r){case"dlig":case"liga":case"rlig":return this.addLigature(t,e,r,s)}},module.exports=Substitution;

},{"./check":2,"./layout":8}],13:[function(require,module,exports){
"use strict";function Table(e,t,o){var r;for(r=0;r<t.length;r+=1){var a=t[r];this[a.name]=a.value}if(this.tableName=e,this.fields=t,o){var u=Object.keys(o);for(r=0;r<u.length;r+=1){var s=u[r],n=o[s];void 0!==this[s]&&(this[s]=n)}}}function ushortList(e,t,o){void 0===o&&(o=t.length);var r=new Array(t.length+1);r[0]={name:e+"Count",type:"USHORT",value:o};for(var a=0;a<t.length;a++)r[a+1]={name:e+a,type:"USHORT",value:t[a]};return r}function tableList(e,t,o){var r=t.length,a=new Array(r+1);a[0]={name:e+"Count",type:"USHORT",value:r};for(var u=0;u<r;u++)a[u+1]={name:e+u,type:"TABLE",value:o(t[u],u)};return a}function recordList(e,t,o){var r=t.length,a=[];a[0]={name:e+"Count",type:"USHORT",value:r};for(var u=0;u<r;u++)a=a.concat(o(t[u],u));return a}function Coverage(e){1===e.format?Table.call(this,"coverageTable",[{name:"coverageFormat",type:"USHORT",value:1}].concat(ushortList("glyph",e.glyphs))):check.assert(!1,"Can't create coverage table format 2 yet.")}function FeatureList(e){Table.call(this,"featureListTable",recordList("featureRecord",e,function(e,t){var o=e.feature;return[{name:"featureTag"+t,type:"TAG",value:e.tag},{name:"feature"+t,type:"TABLE",value:new Table("featureTable",[{name:"featureParams",type:"USHORT",value:o.featureParams}].concat(ushortList("lookupListIndex",o.lookupListIndexes)))}]}))}function LookupList(e,t){Table.call(this,"lookupListTable",tableList("lookup",e,function(e){return new Table("lookupTable",[{name:"lookupType",type:"USHORT",value:e.lookupType},{name:"lookupFlag",type:"USHORT",value:e.lookupFlag}].concat(tableList("subtable",e.subtables,t[e.lookupType])))}))}var check=require("./check"),encode=require("./types").encode,sizeOf=require("./types").sizeOf;Table.prototype.encode=function(){return encode.TABLE(this)},Table.prototype.sizeOf=function(){return sizeOf.TABLE(this)},Coverage.prototype=Object.create(Table.prototype),Coverage.prototype.constructor=Coverage,FeatureList.prototype=Object.create(Table.prototype),FeatureList.prototype.constructor=FeatureList,LookupList.prototype=Object.create(Table.prototype),LookupList.prototype.constructor=LookupList,exports.Record=exports.Table=Table,exports.Coverage=Coverage,exports.FeatureList=FeatureList,exports.LookupList=LookupList,exports.ushortList=ushortList,exports.tableList=tableList,exports.recordList=recordList;
